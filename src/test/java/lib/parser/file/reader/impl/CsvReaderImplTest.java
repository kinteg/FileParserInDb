...
public class CsvReaderImplTest {
    ...
    public void readNext() throws Exception {
        CSVReader csvReader = new CSVReader(new FileReader(new File("/home/kinteg/work/FileParserInDb/src/test/resources/testFiles/TestCsvReaderImpl.csv")));
        Reader reader = new CsvReaderImpl(csvReader);
